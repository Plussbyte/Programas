...
export function enterCheckIn(){
    ...
    acceptButtonCheckIn.addEventListener('click',()=>{
        ...
        console.log(documentCheckInLogic.value.length)
        console.log(iteratorNoLettersCheckIn)

        if(documentCheckInLogic.value.length < 6){
            errorCharactersDocument.style.display = 'flex'
            errorNumbersDocument.style.display = 'none'

        } else if(iteratorNoLettersCheckIn !== documentCheckInLogic.value.length){
